...
const signUp = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (existingUsername) {
            throw (0, http_errors_1.default)(409, "Username Already Taken. Please Choose A Different One");
        }
        const existingEmail = yield user_1.default.findOne({ email: email }).exec();
        if (existingEmail) {
            throw (0, http_errors_1.default)(409, "Email Already Taken. Please Choose A Different One");
        }
...
const login = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!user) {
            throw (0, http_errors_1.default)(401, "Invalid Email");
        }
